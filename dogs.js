...
async function getThreeRandomBreed() {
  try {
    ...
    const randomBreedIndex = Math.floor(Math.random() * totalBreeds);

    let randomBreedIndex2;
    do {
      randomBreedIndex2 = Math.floor(Math.random() * totalBreeds);
    } while (randomBreedIndex2 === randomBreedIndex);

    let randomBreedIndex3;
    do {
      randomBreedIndex3 = Math.floor(Math.random() * totalBreeds);
    } while (randomBreedIndex3 === randomBreedIndex || randomBreedIndex3 === randomBreedIndex2);
